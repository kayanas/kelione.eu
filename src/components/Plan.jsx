    ...
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="pb-6">
          ...
          officiis sint modi maiores perferendis totam distinctio quidem,
          commodi reprehenderit ut iste sequi qui optio esse iusto similique id
          placeat vero!
        </p>
        <div>
          <button className="border-black mr-4 hover:shadow-xl">LEARN MORE</button>
          <button className="bg-black text-white border-black hover:shadow-2xl">BOOK YOUR TRIP</button>
        </div>
      </div>
    </div>
  );
